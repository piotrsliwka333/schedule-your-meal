...
export const RecipesElement = (props) => {
  const {
    saveEditedElement,
    deleteElement,
    text,
  ...
  const handleCheckSaveEditedElement = (
    e,
    array,
    elementToSave,
    newName,
    ...
    <li className="recipes-element">
      ...
      <div className="recipes-element__icon-box">
        <button
          ...
          className="recipes-element__edit-button "
        >
          <i className="far fa-edit" />
        </button>
        <button
          onClick={(e) =>
            handleCheckDeleteElement(
              e,
              array,
              elementToEditOrDelete,
              arrayToEdit
        ...
        {!disabled && (
          <button
            ...
            className="recipes-element__save-button"
          >
