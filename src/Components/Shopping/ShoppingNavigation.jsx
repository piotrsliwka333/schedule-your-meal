...
import { ShoppingNavigationElement } from "./ShoppingNavigationElement";

export const ShoppingNavigation = (props) => {
  ...
  return (
    <nav
      className={
        showOrHide ? "shopping-navigation" : "shopping-navigation hide"
      }
    >
      <div className="nav-option">
        ...
        <select
          ...
          className="nav-option__select"
        >
          {recipes.map((element) => (
            <option
              key={element.id}
              value={element.id}
              className="nav-option__option"
            >
              {element.title}
            </option>
          ))}
