...
export const ApplicationTutorialIntroduction = (props) => {
	...
	return (
		<div className='tutorial-introduction'>
			...
			<Logo/>
			<p className='tutorial-introduction__text'>Dowiesz się w nim jak wykorzystać w pełni aplikację
				zaplanujjedzonko tak żeby żadna nie umkneła twojej uwadze :)
			</p>
			<button onClick={e => checkNextPage(e)} className='home-button tutorial-introduction-btn'>Zaczynajmy</button>
		</div>
	)
}