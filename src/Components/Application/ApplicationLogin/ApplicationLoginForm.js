	...
	return (
		<>
			<form onSubmit={e => loginWithEmailAndPassword(e)} className='login-form'>
				...
				<input id='email-login' type='email' className={loginError ? 'login-form__input error' : 'login-form__input'}
				...
				<input id='password-login' type='password'
				       className={loginError ? 'login-form__input error' : 'login-form__input'} value={password}
