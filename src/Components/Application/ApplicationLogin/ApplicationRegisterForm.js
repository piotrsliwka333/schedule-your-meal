...
export const ApplicationRegisterForm = () => {
	...
	return (
		<>
			<form onSubmit={e => registerNewAccountWithMailAndPassword(e)} className='login-form register-form'>
				<label htmlFor='email-register' className='login-form__label'>Login</label>
				<input id='email-register' type='email'
				       className={registerError ? 'login-form__input error' : 'login-form__input'}
				       value={email} placeholder='Podaj swój email'
				       onChange={e => handleEmailValidation(e)}/>
				<label htmlFor='password-register' className='login-form__label'>Hasło</label>
				<input id='password-register' type='password'
				       className={registerError ? 'login-form__input error' : 'login-form__input'} value={password}
				       placeholder='Podaj swoje hasło'
				       onChange={e => handlePasswordValidation(e)}/>
				<label htmlFor='password-register-repeat' className='login-form__label'>Powtórz hasło</label>
				<input id='password-register-repeat' type='password'
				       className={registerError ? 'login-form__input error' : 'login-form__input'} value={passwordRepeat}
				       placeholder='Podaj swoje hasło'
