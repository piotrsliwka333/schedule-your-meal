	...
	return (
		<ApplicationTemplate>
			<section className='recipes'>
				<Container fluid>
					<Row>
						<ApplicationRecipesDescription instructionsValue={newRecipe.instructions} ingredientsValue={newRecipe.ingredients} addNewRecipe={handleAddNewRecipe} titleValue={newRecipe.title}
