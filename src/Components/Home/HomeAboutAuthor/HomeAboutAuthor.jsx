...
// import Author from "/assets/images/image.png";
        ...
        <Row className="justify-content-center">
          ...
          <Col className="col-10 col-md-10 col-xl-5 about-author__content">
            ...
            <p className="about-author__text">
              ...
              consectetur illum incidunt inventore ipsam ipsum, magni molestias
              natus, necessitatibus officiis porro rem suscipit voluptatem? At
              consequatur laboriosam quam sequi tempore.
            </p>
          </Col>
        </Row>
      </Container>
