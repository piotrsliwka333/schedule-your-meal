...
// import tutorialDesktop from "/assets/images/TutorialDesktop.png";
// import tutorialNewRecipe from "/assets/images/recipeTutorial.png";
// import tutorialRecipeList from "/assets/images/tutorialRecipesList.png";
// import tutorialNewSchedule from "/assets/images/TutorialNewSchedule.png";
// import tutorialScheduleList from "/assets/images/TutorialListaPlanów.png";
// import tutorialShopping from "/assets/images/TutorialShopping.png";
...
export const ApplicationTutorial = (props) => {
  ...
  return (
    <div className="tutorial-container">
      <div className="tutorial-bcg"></div>
      <div className="tutorial">
        <button
          onClick={(e) => handleCheckCloseTutorial(e)}
          className="close-tutorial-btn"
        >
          <i className="fas fa-times" />
        </button>
        {currentPage === 0 && (
          <ApplicationTutorialIntroduction nextPage={nextPage} />
        )}
        {currentPage === 1 && (
          <ApplicationTutorialElement
            nextPage={nextPage}
            previousPage={previousPage}
            image="/assets/images/TutorialDesktop.png"
            title="Pulpit"
        ...
        {currentPage === 2 && (
          <ApplicationTutorialElement
            nextPage={nextPage}
            previousPage={previousPage}
            image="/assets/images/recipeTutorial.png"
            title="Nowy Przepis"
        ...
        {currentPage === 3 && (
          <ApplicationTutorialElement
            nextPage={nextPage}
            previousPage={previousPage}
            image="/assets/images/tutorialRecipesList.png"
        ...
        {currentPage === 4 && (
          <ApplicationTutorialElement
            nextPage={nextPage}
            previousPage={previousPage}
            image="/assets/images/TutorialNewSchedule.png"
            title="Nowy Plan"
        ...
        {currentPage === 5 && (
          <ApplicationTutorialElement
            nextPage={nextPage}
            previousPage={previousPage}
            image="/assets/images/TutorialListaPlanów.png"
            title="Lista Planów"
        ...
        {currentPage === 6 && (
          <ApplicationTutorialElement
            nextPage={nextPage}
            previousPage={previousPage}
            image="/assets/images/TutorialShopping.png"
            title="Zakupy"
        ...
        {currentPage === 7 && (
          <ApplicationTutorialStart closeTutorial={closeTutorial} />
        )}
      </div>
    </div>
  );
