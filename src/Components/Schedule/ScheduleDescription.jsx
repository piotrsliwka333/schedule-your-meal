...
export const ScheduleDescription = (props) => {
  const {
    id,
  ...
  const handleCheckAddOrSaveEditedNewSchedule = (
    e,
    weekNumberValue,
    elementId
  ) => {
    ...
    if (
      typeof handleSaveEditedSchedule === "function" &&
      newOrEdit === "edit"
    ) {
  ...
  return (
    <Col className="recipes__description col-12 p-0">
      <form
        onSubmit={(e) =>
          handleCheckAddOrSaveEditedNewSchedule(e, weekNumberValue, id)
        }
        className="description-form"
      >
        <div className="description-form__box">
          <h1 className="description-form__title highlight">
            {newOrEdit === "edit" ? "Edytuj Plan" : "Nowy Plan"}
          </h1>
          <button
            type="submit"
        ...
        <div className="description-form__box">
          ...
          <input
            value={titleValue}
            onChange={(e) => handleCheckSetTitle(e)}
            className={
              titleError
        ...
        <div className="description-form__box">
          ...
          <textarea
            ...
            onChange={(e) => handleCheckSetDescription(e)}
            name="description"
            className={
              descriptionError
